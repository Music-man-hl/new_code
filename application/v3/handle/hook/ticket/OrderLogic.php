...
use app\v3\model\Shop\OrderTicket;
...
use app\v3\Services\IdCardCheck;
use app\v3\Services\RabbitMQ;
use Exception;
use lib\Status;
use think\Db;
use think\db\Query;
...
class OrderLogic
{
    public static function create($data)
    {
        ...
        if (!OrderQuery::create($orderData, $snap)) {
