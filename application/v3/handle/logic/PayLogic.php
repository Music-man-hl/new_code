...
class PayLogic extends BaseService
{
    ...
    public function wx_app($users)
    {
        ...
        try {
            ...
            $input->SetNotify_url(DOMAIN . '/v3/notify/weixin');  //设置接收微信支付异步通知回调地址
