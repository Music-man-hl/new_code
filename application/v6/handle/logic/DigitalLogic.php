...
use app\v6\handle\hook\ProductInit;
use app\v6\model\Main\Shop;
use app\v6\model\Shop\DigitalArea;
use app\v6\model\Shop\DigitalArticleRecommend;
use app\v6\model\Shop\DigitalLine;
use app\v6\model\Shop\DigitalProduct;
use app\v6\model\Shop\DigitalProductRelation;
use app\v6\model\Shop\DigitalScenic;
use app\v6\model\Shop\DigitalSite;
use app\v6\model\Shop\DigitalSitePoi;
use app\v6\model\Shop\InformationArticle;
use app\v6\model\Shop\InformationArticleExt;
use app\v6\model\Shop\PoiArticle;
use app\v6\model\Shop\PoiArticleTag;
use app\v6\model\Shop\PoiCategory;
use app\v6\model\Shop\PoiTheme;
use app\v6\model\Shop\PoiThemeRelation;
...
//  数字专线首页
    ...
    public function area_list($channels, $all_param)
    {
        ...
        $countyLists = DigitalLine::alias('l')->join([DigitalArea::getTable() => 'a'], 'a.id=l.area_id')->field('l.name as title,l.id,l.cover,l.run_status')
