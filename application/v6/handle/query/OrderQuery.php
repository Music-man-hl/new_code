...
namespace app\v6\handle\query;

use app\v6\model\Shop\Coupon;
use app\v6\model\Shop\CouponCode;
use app\v6\model\Shop\CouponProduct;
...
use app\v6\model\Shop\OrderRefund;
use app\v6\model\Shop\OrderRefundLog;
use app\v6\model\Shop\OrderRefundType;
use Exception;
...
class OrderQuery
{
    ...
    function getOrderById($channels, $users, $order)
    {
        ...
        $field = 'o.*,i.data,e.confirm_time,e.remark,e.assist_check_no,e.qrcode_img_url,r.id rid,r.create rcreate,r.update rupdate';
