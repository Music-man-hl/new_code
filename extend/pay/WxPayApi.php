...
class WxPayApi
{
    ...
    public static function checkSign($inputObj, $timeOut = 6)
    {
        $url = "https://api.mch.weixin.qq.com/pay/downloadbill";
        //检测必填参数
        if (!$inputObj->IsBill_dateSet()) {
        ...
        if( in_array( $obj->error_code ,[20002,20007]) ) return true;
        if( $obj->error_code == 20001 ){
            return $obj->return_msg != 'sign error';
        }
        return false;
    }
